...
(function($) {
    ...
    jQuery(document).ready(function() {
        ...
        $(function() {
            element.typed({
                strings: ["K2 leverages analytics", "K2 monitizes your intuition", "K2 is results-oriented", "K2 disrupts mainstream finance"],
                typeSpeed: 100,
                loop: true,
            });
        });
